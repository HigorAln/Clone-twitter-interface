  ...
  return (
    <div className="flex-col flex-1 w-full px-4 my-2 py-2 overflow-hidden sticky top-0 max-h-screen hidden lg:flex">
      <label
        ...
        className="flex gap-3 items-center p-[9px] px-5 rounded-full bg-[#eff3f4]"
      >
      ...
      <div className="bg-[#f3f5f6] mt-4 w-full rounded-2xl h-auto flex flex-col gap-4 overflow-hidden">
        ...
        <a className="flex items-center text-violet-500 self-start text-[13px] hover:bg-gray-200 w-full h-12 text-start px-5 tracking-tight">
          Show more
        </a>
      </div>
    </div>
