      ...
      <div className="flex pt-2">
        ...
        <div className="flex flex-col w-full">
            ...
            <div className="border-b border-b-gray-100 my-3 ">
              <button className="flex gap-2 my-1 items-center px-2 py-[2px] hover:bg-purple-100 rounded-full transition-colors">
                <GlobeHemisphereWest
                  ...
                  weight="fill"
                />
                <p className="text-xs font-bold text-primary_purple">
                  Everyone can reply
                </p>
              </button>
            </div>
          ...
          <div className="flex flex-1 justify-between">
            ...
            <button
              className="flex items-center justify-center border rounded-full bg-[#7856FF] text-white text-sm font-bold w-[75px] h-[38px] disabled:opacity-50 mb-3"
