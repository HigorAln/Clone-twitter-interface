...
export function ExploreComponent() {
  return (
    <main className="min-w-0 md:min-w-[600px] max-w-none md:max-w-[600px] flex-2 w-full border border-gray-100 relative">
      <div className="flex w-full items-center px-4 m-3">
        <label
          htmlFor="search_twitter"
          className="flex flex-1 gap-3 items-center p-[10px] px-5 rounded-full bg-[#eff3f4]"
        >
          ...
          <input
            ...
            className="text-[15px] text-gray-800 focus:border-none outline-none bg-transparent placeholder:text-gray-500"
          />
        </label>
      ...
      <span className="w-full flex">
        <button className="hover:bg-gray-200 transition-all rounded-sm py-2 text-gray-900 relative">
        ...
        <button className="hover:bg-gray-200 transition-all rounded-sm py-2 text-gray-900 relative">
          <p className="px-4 whitespace-nowrap text-sm after_explorer">News</p>
        </button>
        <button className="hover:bg-gray-200 transition-all rounded-sm py-2 text-gray-900 relative">
          <p className="px-4 whitespace-nowrap text-sm after_explorer">
            Sports
